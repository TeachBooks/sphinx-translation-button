...
import os
import sys
sys.path.append(os.path.abspath('sphinx-translation-button'))
...
extensions = ['sphinx_togglebutton', 'sphinx_copybutton', 'myst_nb', 'jupyter_book', 'sphinx_thebe', 'sphinx_comments', 'sphinx_external_toc', 'sphinx.ext.intersphinx', 'sphinx_design', 'sphinx_book_theme', 'sphinx-translation-button', 'sphinxcontrib.bibtex', 'sphinx_jupyterbook_latex']
